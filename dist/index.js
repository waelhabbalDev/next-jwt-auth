...
function createAuth(config) {
    ...
    const getAuthSession = async () => {
        const { session, newTokens } = await (0, authentication_1.getAuthSession)(effectiveConfig);
        if (newTokens) {
    ...
    const signIn = (signInIdentifier, secret) => (0, authentication_1.signIn)(signInIdentifier, secret, effectiveConfig);
