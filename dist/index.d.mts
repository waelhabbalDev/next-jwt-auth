...
import { U as UserIdentity, P as PublicUserIdentity, a as UserIdentityDAL, A as AuthSession } from './errors-DznFvHN8.mjs';
export { b as AuthCookieConfig, c as AuthError, C as CookieOptions, F as ForbiddenError, d as IdentityForbiddenError, I as InvalidCredentialsError, N as NotAuthenticatedError, R as RefreshTokenPayload, T as TokenPair } from './errors-DznFvHN8.mjs';
...
interface AuthConfig<T extends UserIdentity> {
    ...
    /** Strategy for refresh token rotation. "always" is recommended for maximum security. */
